...
DISPATCH: dict[str, tuple[str, str]] = {
    ...
    "cidr":        ("cyberkit.cidr",        "IPv4 / IPv6 subnet calculator (info/contains/summarize/split)"),
    "whois":       ("cyberkit.whois",       "WHOIS client (TCP/43) with IANA referral chasing"),
    ...
    "tlsenum":     ("cyberkit.tlsenum",     "Enumerate supported TLS versions, ciphers, and features"),
    ...
    "crackzip":    ("cyberkit.crackzip",    "Crack ZipCrypto-encrypted .zip files (+--rules)"),
    ...
    "pcap":        ("cyberkit.pcap",        "Read libpcap files; protocol histogram / top talkers / per-packet"),
